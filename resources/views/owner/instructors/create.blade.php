        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('owner.instructors.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="dateOfBirth" name="dateOfBirth" type="date" class="mt-1 block w-full" required />
                            <x-input-error :messages="$errors->get('dateOfBirth')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="bsnNumber" value="BSN" />
                            <x-text-input id="bsnNumber" name="bsnNumber" type="text" class="mt-1 block w-full" required />
